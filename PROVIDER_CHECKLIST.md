...
The [provider-mqttprovider](https://github.com/crossplane/provider-mqttprovider) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-mqttprovider](https://github.com/crossplane-contrib/provider-jet-mqttprovider) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/crossplane/provider-mqttprovider/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/crossplane/provider-mqttprovider/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/crossplane/provider-mqttprovider/blob/main/hack/boilerplate.go.txt](https://github.com/crossplane/provider-mqttprovider/blob/main/hack/boilerplate.go.txt)
...
The [provider-mqttprovider](https://github.com/crossplane/provider-mqttprovider)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/crossplane/provider-mqttprovider/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/crossplane/provider-mqttprovider/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue mqttproviders (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/crossplane/provider-mqttprovider/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request MqttProviders: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/crossplane/provider-mqttprovider/blob/master/.github/PULL_REQUEST_TEMPLATE.md))

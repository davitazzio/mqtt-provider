# ====================================================================================
# Setup Project
PROJECT_NAME := provider-mqttprovider
...
XPKGS = provider-mqttprovider
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-mqttprovider: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider MqttProvider CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider MqttProvider controllers
...
# This target prepares repo for your provider by replacing all "mqttprovider"
